...
WebUI.navigateToUrl('https://devstu.apu.edu/')

WebUI.click(findTestObject('Manual/CAS login'))

WebUI.setText(findTestObject('Object Repository/CAS/Page_Login - CAS  Central Authentication Service/input_username'), GlobalVariable.username)

WebUI.setEncryptedText(findTestObject('Object Repository/CAS/Page_Login - CAS  Central Authentication Service/input_password'), 
    GlobalVariable.password)

'If there is no NETID the submit button will be un-clickable and this would fail'
WebUI.click(findTestObject('Object Repository/CAS/Page_Login - CAS  Central Authentication Service/submit'))
